...
public class Manager implements TextGraphicsConverter {
    private int maxWidth;
    private int maxHeight;


    public Manager(int maxWidth, int maxHeight){
    ...
    public String convert(String url) throws IOException, BadImageSizeException {
        ...
        System.out.println("Нужно проверить соотношение сторон? (Y ro N)");
        String inputCommand = read.readLine();
        ...
        if (){
            ...
            int newW = Integer.parseInt(read.readLine());
            System.out.println("Введите высоту изображения: ");
            int newH = Integer.parseInt(read.readLine());
            Manager manager = new Manager(newW, newH);
            int w = img.getWidth();
            int h = img.getHeight();
            System.out.println(w + " " + h);
            //checkRatio(w, h);
            double ratio = w / h;
            manager.setMaxRatio(ratio);
        }
    ...
    public void setMaxRatio(double maxRatio) throws BadImageSizeException {
        ...
        if (maxRatio < ratio) throw new BadImageSizeException(ratio, maxRatio);
